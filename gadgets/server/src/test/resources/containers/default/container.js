...
"gadgets.features" : {
  "core.io" : {
    ...
    "proxyUrl" : "//%authority%/eXoGadgetServer/gadgets/proxy?container=default&refresh=%refresh%&url=%url%%rewriteMime%",
    "jsonProxyUrl" : "//%authority%/eXoGadgetServer/gadgets/makeRequest",
  ...
  "opensocial" : {
    ...
    "path" : "http://%authority%/social/rpc",
    // Path to issue invalidate calls
    "invalidatePath" : "http://%authority%/social/rpc",
    "domain" : "shindig",
    "enableCaja" : false,
    "supportedFields" : {
