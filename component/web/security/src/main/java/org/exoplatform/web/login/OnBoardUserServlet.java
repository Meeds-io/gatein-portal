 ...
 * @version $Revision$
 */
public class OnBoardUserServlet extends AbstractHttpServlet {
    ...
    /** . */
    private static final Log log = ExoLogger.getLogger(OnBoardUserServlet.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (status == AUTHENTICATED) {
            ...
            if(ssoHelper.skipJSPRedirection() && meetDisabledUser) {
                ...
                StringBuilder loginPath = new StringBuilder("/login/jsp/onBoardUser.jsp");
                if (meetDisabledUser) {
