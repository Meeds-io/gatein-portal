...
@Component
public class SpringBeanFactoryPostProcessor implements BeanFactoryPostProcessor, BeanPostProcessor, ApplicationContextAware {

  private static final Logger    LOG = LoggerFactory.getLogger(SpringBeanFactoryPostProcessor.class);
  ...
  public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
    if (applicationContext == null) {
      LOG.error("Application context seems to be empty. Can't integrate Spring with Kernel");
      return;
    }
