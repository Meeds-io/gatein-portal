...
/**
 * <p>
 * The chromattic life cycle objets is a plugin that allow to bootstrap a chromattic builder and make it managed either locally
 * or globally.
 * </p>
 *
 * <p>
 * It is allowed to create subclasses of this class to override the methods {@link #onOpenSession(SessionContext)} or
 * {@link #onCloseSession(SessionContext)} to perform additional treatment on the session context at a precise phase of its life
 * cycle.
 * </p>
 *
 * <p>
...
public class ChromatticLifeCycle extends BaseComponentPlugin {
    ...
    static {
        ...
        for (ChromatticBuilder.Option<?> option : new ChromatticBuilder.Option<?>[] { ChromatticBuilder.JCR_OPTIMIZE_ENABLED,
                ChromatticBuilder.JCR_OPTIMIZE_HAS_NODE_ENABLED, ChromatticBuilder.JCR_OPTIMIZE_HAS_PROPERTY_ENABLED,
                ChromatticBuilder.OBJECT_FORMATTER_CLASSNAME, ChromatticBuilder.ROOT_NODE_PATH,
    ...
    /**
     * Opens a context and returns it. If there is a global ongoing synchronization then the context will be scoped to that
     * synchronization, otherwise it will be a local context.
     *
