...
public class UserACL {
   ...
   * @return true if have access permission else false
   */
  public boolean hasAccessPermission(PageContext page, Identity identity) {
    return hasAccessPermission(identity,
                               page.getKey().getSite().getTypeName(),
                               page.getKey().getSite().getName(),
                               page.getState().getAccessPermissions())
           || hasEditPermission(page, identity);
  }
