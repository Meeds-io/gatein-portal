...
public class PageMarshallerTest extends AbstractMarshallerTest {
    ...
    public void testEmptyPageUnmarshalling() {
        ...
        try {
            ...
            assertArrayEquals(new String [] {Container.EVERYONE}, page.getMoveAppsPermissions());
            assertArrayEquals(new String [] {Container.EVERYONE}, page.getMoveContainersPermissions());
            assertNotNull(page.getChildren());
