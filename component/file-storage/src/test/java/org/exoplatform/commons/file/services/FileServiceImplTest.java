...
public class FileServiceImplTest {
  ...
  public void shouldDeleteFile() throws Exception {
    ...
    lenient().when(jpaDataStorage.updateFileInfo(any(FileInfo.class))).thenReturn(new FileInfo(1L, "file", null, "file", 1, null, "", "d41d8cd98f00b204e9800998ecf8427e", true));
    ...
    // Then
    verify(jpaDataStorage, times(1)).updateFileInfo(any(FileInfo.class));
    verify(listenerService, times(1)).broadcast("file.deleted", fileInfo, null);
  }
