...
<%
    ...
    String externalRegistrationURLPath = passRecoveryServ.getExternalRegistrationURL(tokenId, I18N.toTagIdentifier(locale));
			...
			<div class="loginContent">
              ...
              <%}%>
					...
					<form name="registerForm" action="<%= contextPath + externalRegistrationURLPath %>" method="post">
						...
						<p class="passwordCondition"><i class="uiIconInfo"></i><%=passwordCondition != null ? passwordCondition : res.getString("external.registration.passwordCondition")%></p>
						<div class="userCredentials">
						   <span class="iconPswrd"></span>
