 ...
 * Nov 22, 2008
 */
@ComponentConfig(lifecycle = UIFormLifecycle.class, template = "system:/groovy/webui/organization/account/UIUserGroupSelector.gtmpl", events = {
        @EventConfig(listeners = UIUserGroupSelector.AddActionListener.class, phase = Phase.DECODE),
        @EventConfig(listeners = UIUserGroupSelector.AddUserActionListener.class, phase = Phase.DECODE),
        @EventConfig(listeners = UIUserGroupSelector.SearchActionListener.class, phase = Phase.DECODE),
        @EventConfig(listeners = UIUserGroupSelector.SearchGroupActionListener.class, phase = Phase.DECODE),
        @EventConfig(listeners = UIUserGroupSelector.SelectGroupActionListener.class, phase = Phase.DECODE),
        @EventConfig(listeners = UIUserGroupSelector.FindGroupActionListener.class, phase = Phase.DECODE),
        @EventConfig(listeners = UIUserGroupSelector.ShowPageActionListener.class, phase = Phase.DECODE),
        @EventConfig(listeners = UIUserGroupSelector.CloseActionListener.class, phase = Phase.DECODE) })
@Serialized
public class UIUserGroupSelector extends UIForm implements UIPopupComponent {
    ...
    public static class AddUserActionListener extends EventListener<UIUserGroupSelector> {
        public void execute(Event<UIUserGroupSelector> event) throws Exception {
            UIUserGroupSelector uiForm = event.getSource();
    ...
    public static class SelectGroupActionListener extends EventListener<UIGroupSelector> {
        public void execute(Event<UIGroupSelector> event) throws Exception {
            ...
            UIUserGroupSelector uiSelectUserForm = uiSelectGroupForm.<UIComponent> getParent().getParent();
    ...
    public static class FindGroupActionListener extends EventListener<UIUserGroupSelector> {
        public void execute(Event<UIUserGroupSelector> event) throws Exception {
    ...
    @SuppressWarnings("unchecked")
    public static class SearchActionListener extends EventListener<UIUserGroupSelector> {
        public void execute(Event<UIUserGroupSelector> event) throws Exception {
            UIUserGroupSelector uiForm = event.getSource();
    ...
    public static class SearchGroupActionListener extends EventListener<UIUserGroupSelector> {
        public void execute(Event<UIUserGroupSelector> event) throws Exception {
            UIUserGroupSelector uiForm = event.getSource();
    ...
    public static class ShowPageActionListener extends EventListener<UIUserGroupSelector> {
        public void execute(Event<UIUserGroupSelector> event) throws Exception {
            UIUserGroupSelector uiSelectUserForm = event.getSource();
